...
// checks if the UploadWithOmissions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UploadWithOmissions{}
...
type _UploadWithOmissions UploadWithOmissions
...
func (o UploadWithOmissions) MarshalJSON() ([]byte, error) {
...
func (o UploadWithOmissions) ToMap() (map[string]interface{}, error) {
...
func (o *UploadWithOmissions) UnmarshalJSON(data []byte) (err error) {
	...
	varUploadWithOmissions := _UploadWithOmissions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUploadWithOmissions)

	if err != nil {
		return err
	}

	*o = UploadWithOmissions(varUploadWithOmissions)

	return err
}

type NullableUploadWithOmissions struct {
	value *UploadWithOmissions
	isSet bool
}

func (v NullableUploadWithOmissions) Get() *UploadWithOmissions {
	return v.value
}

func (v *NullableUploadWithOmissions) Set(val *UploadWithOmissions) {
	v.value = val
	v.isSet = true
}

func (v NullableUploadWithOmissions) IsSet() bool {
	return v.isSet
}

func (v *NullableUploadWithOmissions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUploadWithOmissions(val *UploadWithOmissions) *NullableUploadWithOmissions {
	return &NullableUploadWithOmissions{value: val, isSet: true}
}

func (v NullableUploadWithOmissions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUploadWithOmissions) UnmarshalJSON(src []byte) error {
	v.isSet = true
