...
const (
	HOME_OF_RECORD DestinationType = "HOME_OF_RECORD"
	HOME_OF_SELECTION DestinationType = "HOME_OF_SELECTION"
	PLACE_ENTERED_ACTIVE_DUTY DestinationType = "PLACE_ENTERED_ACTIVE_DUTY"
	OTHER_THAN_AUTHORIZED DestinationType = "OTHER_THAN_AUTHORIZED"
)
