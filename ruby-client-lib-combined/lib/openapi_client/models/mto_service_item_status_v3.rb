...
module OpenapiClient
  class MTOServiceItemStatusV3
    SUBMITTED = "SUBMITTED".freeze
    APPROVED = "APPROVED".freeze
    REJECTED = "REJECTED".freeze

    def self.all_vars
      @all_vars ||= [SUBMITTED, APPROVED, REJECTED].freeze
    end
    ...
    def build_from_hash(value)
      return value if MTOServiceItemStatusV3.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #MTOServiceItemStatusV3"
    end
  end
end
