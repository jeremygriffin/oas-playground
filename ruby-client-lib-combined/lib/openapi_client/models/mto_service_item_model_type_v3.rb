...
module OpenapiClient
  class MTOServiceItemModelTypeV3
    ...
    def build_from_hash(value)
      return value if MTOServiceItemModelTypeV3.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #MTOServiceItemModelTypeV3"
    end
  end
end
