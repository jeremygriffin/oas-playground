...
module OpenapiClient
  class ServiceItemParamTypeV3
    STRING = "STRING".freeze
    DATE = "DATE".freeze
    INTEGER = "INTEGER".freeze
    DECIMAL = "DECIMAL".freeze
    TIMESTAMP = "TIMESTAMP".freeze
    PAYMENT_SERVICE_ITEM_UUID = "PaymentServiceItemUUID".freeze
    BOOLEAN = "BOOLEAN".freeze

    def self.all_vars
      @all_vars ||= [STRING, DATE, INTEGER, DECIMAL, TIMESTAMP, PAYMENT_SERVICE_ITEM_UUID, BOOLEAN].freeze
    end
    ...
    def build_from_hash(value)
      return value if ServiceItemParamTypeV3.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ServiceItemParamTypeV3"
    end
  end
end
