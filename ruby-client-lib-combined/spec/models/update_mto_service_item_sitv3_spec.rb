...
# Unit tests for OpenapiClient::UpdateMTOServiceItemSITV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateMTOServiceItemSITV3 do
  let(:instance) { OpenapiClient::UpdateMTOServiceItemSITV3.new }

  describe 'test an instance of UpdateMTOServiceItemSITV3' do
    it 'should create an instance of UpdateMTOServiceItemSITV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::UpdateMTOServiceItemSITV3)
    end
  end
