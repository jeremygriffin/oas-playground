...
# Unit tests for OpenapiClient::OrdersTypeV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrdersTypeV3 do
  let(:instance) { OpenapiClient::OrdersTypeV3.new }

  describe 'test an instance of OrdersTypeV3' do
    it 'should create an instance of OrdersTypeV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrdersTypeV3)
    end
  end
