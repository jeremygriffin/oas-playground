...
# Unit tests for OpenapiClient::MTOServiceItemShuttleV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MTOServiceItemShuttleV3 do
  let(:instance) { OpenapiClient::MTOServiceItemShuttleV3.new }

  describe 'test an instance of MTOServiceItemShuttleV3' do
    it 'should create an instance of MTOServiceItemShuttleV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MTOServiceItemShuttleV3)
    end
  end
