...
# Unit tests for OpenapiClient::DutyLocationV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DutyLocationV3 do
  let(:instance) { OpenapiClient::DutyLocationV3.new }

  describe 'test an instance of DutyLocationV3' do
    it 'should create an instance of DutyLocationV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DutyLocationV3)
    end
  end
