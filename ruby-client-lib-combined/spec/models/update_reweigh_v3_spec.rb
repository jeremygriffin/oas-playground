...
# Unit tests for OpenapiClient::UpdateReweighV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateReweighV3 do
  let(:instance) { OpenapiClient::UpdateReweighV3.new }

  describe 'test an instance of UpdateReweighV3' do
    it 'should create an instance of UpdateReweighV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::UpdateReweighV3)
    end
  end
