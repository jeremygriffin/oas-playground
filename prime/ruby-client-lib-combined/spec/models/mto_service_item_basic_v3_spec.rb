...
# Unit tests for OpenapiClient::MTOServiceItemBasicV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MTOServiceItemBasicV3 do
  let(:instance) { OpenapiClient::MTOServiceItemBasicV3.new }

  describe 'test an instance of MTOServiceItemBasicV3' do
    it 'should create an instance of MTOServiceItemBasicV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MTOServiceItemBasicV3)
    end
  end
