...
# Unit tests for OpenapiClient::ReweighV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReweighV3 do
  let(:instance) { OpenapiClient::ReweighV3.new }

  describe 'test an instance of ReweighV3' do
    it 'should create an instance of ReweighV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReweighV3)
    end
  end
