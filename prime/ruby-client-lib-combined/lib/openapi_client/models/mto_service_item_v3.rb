...
module OpenapiClient
  ...
  class MTOServiceItemV3
    ...
    attr_accessor :service_request_documents
    ...
    def self.openapi_types
      {
        ...
        :'status' => :'MTOServiceItemStatusV3',
        :'rejection_reason' => :'String',
        :'model_type' => :'MTOServiceItemModelTypeV3',
        :'service_request_documents' => :'Array<ServiceRequestDocumentV3>',
        :'e_tag' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::MTOServiceItemV3` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::MTOServiceItemV3`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'re_service_name')
        self.re_service_name = attributes[:'re_service_name']
      end
      ...
      if attributes.key?(:'service_request_documents')
        if (value = attributes[:'service_request_documents']).is_a?(Array)
          self.service_request_documents = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_request_documents == o.service_request_documents &&
          e_tag == o.e_tag
    end
    ...
    def hash
      [id, move_task_order_id, mto_shipment_id, re_service_name, status, rejection_reason, model_type, service_request_documents, e_tag].hash
    end
