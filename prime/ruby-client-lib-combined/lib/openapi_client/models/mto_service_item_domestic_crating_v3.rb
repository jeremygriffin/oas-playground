...
module OpenapiClient
  ...
  class MTOServiceItemDomesticCratingV3 < MTOServiceItemV3
    ...
    attr_accessor :standalone_crate
    ...
    def self.attribute_map
      {
        ...
        :'reason' => :'reason',
        :'standalone_crate' => :'standaloneCrate'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::MTOServiceItemDomesticCratingV3` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::MTOServiceItemDomesticCratingV3`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'standalone_crate')
        self.standalone_crate = attributes[:'standalone_crate']
      end
    end
    ...
    def valid?
      ...
      re_service_code_validator = EnumAttributeValidator.new('String', ["DCRT", "DUCRT"])
    ...
    def re_service_code=(re_service_code)
      validator = EnumAttributeValidator.new('String', ["DCRT", "DUCRT"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reason == o.reason &&
          standalone_crate == o.standalone_crate && super(o)
    end
    ...
    def hash
      [re_service_code, item, crate, description, reason, standalone_crate].hash
    end
