...
module OpenapiClient
  class PaymentServiceItemStatusV3
    ...
    def build_from_hash(value)
      return value if PaymentServiceItemStatusV3.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PaymentServiceItemStatusV3"
    end
  end
end
