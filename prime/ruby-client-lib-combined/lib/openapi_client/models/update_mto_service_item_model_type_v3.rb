...
module OpenapiClient
  class UpdateMTOServiceItemModelTypeV3
    ...
    def build_from_hash(value)
      return value if UpdateMTOServiceItemModelTypeV3.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #UpdateMTOServiceItemModelTypeV3"
    end
  end
end
