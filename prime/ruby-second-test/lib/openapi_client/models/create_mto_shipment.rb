...
module OpenapiClient
  class CreateMTOShipment
    ...
    def hash
      [move_task_order_id, requested_pickup_date, prime_estimated_weight, customer_remarks, agents, mto_service_items, pickup_address, destination_address, shipment_type, diversion, point_of_contact, counselor_remarks, ppm_shipment].hash
    end
