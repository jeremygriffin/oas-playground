...
# Unit tests for OpenapiClient::CreateSITExtension
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateSITExtension do
  let(:instance) { OpenapiClient::CreateSITExtension.new }

  describe 'test an instance of CreateSITExtension' do
    it 'should create an instance of CreateSITExtension' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateSITExtension)
    end
  end
