...
# Unit tests for OpenapiClient::ClientError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ClientError do
  let(:instance) { OpenapiClient::ClientError.new }

  describe 'test an instance of ClientError' do
    it 'should create an instance of ClientError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ClientError)
    end
  end
