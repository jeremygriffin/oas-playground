...
# Unit tests for OpenapiClient::Reweigh
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Reweigh do
  let(:instance) { OpenapiClient::Reweigh.new }

  describe 'test an instance of Reweigh' do
    it 'should create an instance of Reweigh' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Reweigh)
    end
  end
