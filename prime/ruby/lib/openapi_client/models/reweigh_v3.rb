...
module OpenapiClient
  ...
  class ReweighV3
    ...
    attr_accessor :verification_provided_at
    ...
    def self.attribute_map
      {
        ...
        :'verification_provided_at' => :'verificationProvidedAt',
    ...
    def self.openapi_types
      {
        :'id' => :'String',
        :'requested_at' => :'Time',
        :'requested_by' => :'ReweighRequesterV3',
        :'verification_provided_at' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ReweighV3` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ReweighV3`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'verification_provided_at')
        self.verification_provided_at = attributes[:'verification_provided_at']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          verification_provided_at == o.verification_provided_at &&
    ...
    def hash
      [id, requested_at, requested_by, verification_provided_at, verification_reason, weight, shipment_id, created_at, updated_at, e_tag].hash
    end
