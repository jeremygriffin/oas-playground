...
module OpenapiClient
  class ReweighRequesterV3
    ...
    def self.all_vars
      @all_vars ||= [CUSTOMER, PRIME, SYSTEM, TOO].freeze
    end
    ...
    def build_from_hash(value)
      return value if ReweighRequesterV3.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ReweighRequesterV3"
    end
  end
end
