...
module OpenapiClient
  class ShipmentAddressUpdateStatusV3
    ...
    def build_from_hash(value)
      return value if ShipmentAddressUpdateStatusV3.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ShipmentAddressUpdateStatusV3"
    end
  end
end
