  ...
  class MoveTaskOrderV3
    ...
    def self.openapi_types
      {
        ...
        :'payment_requests' => :'Array<PaymentRequestV3>',
        :'mto_service_items' => :'Array<MTOServiceItemV3>',
        :'mto_shipments' => :'Array<MTOShipmentWithoutServiceItemsV3>',
        :'ppm_type' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::MoveTaskOrderV3` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::MoveTaskOrderV3`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, move_code, created_at, order_id, order, reference_id, available_to_prime_at, updated_at, prime_counseling_completed_at, payment_requests, mto_service_items, mto_shipments, ppm_type, ppm_estimated_weight, excess_weight_qualified_at, excess_weight_acknowledged_at, excess_weight_upload_id, contract_number, e_tag].hash
    end
