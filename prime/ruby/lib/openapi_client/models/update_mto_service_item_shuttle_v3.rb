...
module OpenapiClient
  ...
  class UpdateMTOServiceItemShuttleV3 < UpdateMTOServiceItemV3
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::UpdateMTOServiceItemShuttleV3` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::UpdateMTOServiceItemShuttleV3`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      re_service_code_validator = EnumAttributeValidator.new('String', ["DDSHUT", "DOSHUT"])
    ...
    def re_service_code=(re_service_code)
      validator = EnumAttributeValidator.new('String', ["DDSHUT", "DOSHUT"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          re_service_code == o.re_service_code && super(o)
    end
    ...
    def hash
      [actual_weight, estimated_weight, re_service_code].hash
    end
