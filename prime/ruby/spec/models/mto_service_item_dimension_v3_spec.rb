...
# Unit tests for OpenapiClient::MTOServiceItemDimensionV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MTOServiceItemDimensionV3 do
  let(:instance) { OpenapiClient::MTOServiceItemDimensionV3.new }

  describe 'test an instance of MTOServiceItemDimensionV3' do
    it 'should create an instance of MTOServiceItemDimensionV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MTOServiceItemDimensionV3)
    end
  end
