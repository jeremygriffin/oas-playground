...
# Unit tests for OpenapiClient::UpdateMTOServiceItemShuttleV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateMTOServiceItemShuttleV3 do
  let(:instance) { OpenapiClient::UpdateMTOServiceItemShuttleV3.new }

  describe 'test an instance of UpdateMTOServiceItemShuttleV3' do
    it 'should create an instance of UpdateMTOServiceItemShuttleV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::UpdateMTOServiceItemShuttleV3)
    end
  end
