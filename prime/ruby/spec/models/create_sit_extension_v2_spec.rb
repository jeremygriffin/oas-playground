...
# Unit tests for OpenapiClient::CreateSITExtensionV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateSITExtensionV2 do
  let(:instance) { OpenapiClient::CreateSITExtensionV2.new }

  describe 'test an instance of CreateSITExtensionV2' do
    it 'should create an instance of CreateSITExtensionV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateSITExtensionV2)
    end
  end
