...
# Unit tests for OpenapiClient::ErrorV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ErrorV3 do
  let(:instance) { OpenapiClient::ErrorV3.new }

  describe 'test an instance of ErrorV3' do
    it 'should create an instance of ErrorV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ErrorV3)
    end
  end
