...
# Unit tests for OpenapiClient::ClientErrorV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ClientErrorV3 do
  let(:instance) { OpenapiClient::ClientErrorV3.new }

  describe 'test an instance of ClientErrorV3' do
    it 'should create an instance of ClientErrorV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ClientErrorV3)
    end
  end
