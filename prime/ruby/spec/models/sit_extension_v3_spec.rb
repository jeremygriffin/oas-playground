...
# Unit tests for OpenapiClient::SITExtensionV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SITExtensionV3 do
  let(:instance) { OpenapiClient::SITExtensionV3.new }

  describe 'test an instance of SITExtensionV3' do
    it 'should create an instance of SITExtensionV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SITExtensionV3)
    end
  end
