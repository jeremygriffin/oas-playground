...
# Unit tests for OpenapiClient::ValidationErrorV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ValidationErrorV3 do
  let(:instance) { OpenapiClient::ValidationErrorV3.new }

  describe 'test an instance of ValidationErrorV3' do
    it 'should create an instance of ValidationErrorV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ValidationErrorV3)
    end
  end
