...
# Unit tests for OpenapiClient::ProofOfServiceDocV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ProofOfServiceDocV3 do
  let(:instance) { OpenapiClient::ProofOfServiceDocV3.new }

  describe 'test an instance of ProofOfServiceDocV3' do
    it 'should create an instance of ProofOfServiceDocV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ProofOfServiceDocV3)
    end
  end
