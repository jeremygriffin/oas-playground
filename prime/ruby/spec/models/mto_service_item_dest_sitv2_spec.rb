...
# Unit tests for OpenapiClient::MTOServiceItemDestSITV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MTOServiceItemDestSITV2 do
  let(:instance) { OpenapiClient::MTOServiceItemDestSITV2.new }

  describe 'test an instance of MTOServiceItemDestSITV2' do
    it 'should create an instance of MTOServiceItemDestSITV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MTOServiceItemDestSITV2)
    end
  end
