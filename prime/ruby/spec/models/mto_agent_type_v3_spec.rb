...
# Unit tests for OpenapiClient::MTOAgentTypeV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MTOAgentTypeV3 do
  let(:instance) { OpenapiClient::MTOAgentTypeV3.new }

  describe 'test an instance of MTOAgentTypeV3' do
    it 'should create an instance of MTOAgentTypeV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MTOAgentTypeV3)
    end
  end
