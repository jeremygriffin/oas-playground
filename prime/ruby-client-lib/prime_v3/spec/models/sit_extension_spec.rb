...
# Unit tests for OpenapiClient::SITExtension
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SITExtension do
  let(:instance) { OpenapiClient::SITExtension.new }

  describe 'test an instance of SITExtension' do
    it 'should create an instance of SITExtension' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SITExtension)
    end
  end
