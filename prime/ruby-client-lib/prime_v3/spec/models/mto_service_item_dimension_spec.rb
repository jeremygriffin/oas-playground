...
# Unit tests for OpenapiClient::MTOServiceItemDimension
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MTOServiceItemDimension do
  let(:instance) { OpenapiClient::MTOServiceItemDimension.new }
  ...
  describe 'test an instance of MTOServiceItemDimension' do
    it 'should create an instance of MTOServiceItemDimension' do
      ...
      #expect(instance).to be_instance_of(OpenapiClient::MTOServiceItemDimension)
    end
  end
