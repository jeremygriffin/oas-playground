...
// checks if the UploadWithOmissionsV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UploadWithOmissionsV2{}

// UploadWithOmissionsV2 An uploaded file.
type UploadWithOmissionsV2 struct {
...
type _UploadWithOmissionsV2 UploadWithOmissionsV2
...
func (o UploadWithOmissionsV2) MarshalJSON() ([]byte, error) {
...
func (o UploadWithOmissionsV2) ToMap() (map[string]interface{}, error) {
...
func (o *UploadWithOmissionsV2) UnmarshalJSON(data []byte) (err error) {
	...
	varUploadWithOmissionsV2 := _UploadWithOmissionsV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUploadWithOmissionsV2)

	if err != nil {
		return err
	}

	*o = UploadWithOmissionsV2(varUploadWithOmissionsV2)

	return err
}

type NullableUploadWithOmissionsV2 struct {
	value *UploadWithOmissionsV2
	isSet bool
}

func (v NullableUploadWithOmissionsV2) Get() *UploadWithOmissionsV2 {
	return v.value
}

func (v *NullableUploadWithOmissionsV2) Set(val *UploadWithOmissionsV2) {
	v.value = val
	v.isSet = true
}

func (v NullableUploadWithOmissionsV2) IsSet() bool {
	return v.isSet
}

func (v *NullableUploadWithOmissionsV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUploadWithOmissionsV2(val *UploadWithOmissionsV2) *NullableUploadWithOmissionsV2 {
	return &NullableUploadWithOmissionsV2{value: val, isSet: true}
}

func (v NullableUploadWithOmissionsV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUploadWithOmissionsV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
