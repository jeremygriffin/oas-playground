...
// checks if the SITExtensionV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SITExtensionV2{}

// SITExtensionV2 A storage in transit (SIT) Extension is a request for an increase in the billable number of days a shipment is allowed to be in SIT.
type SITExtensionV2 struct {
...
func (o *SITExtensionV2) SetContractorRemarksNil() {
...
func (o *SITExtensionV2) SetApprovedDaysNil() {
...
func (o *SITExtensionV2) SetDecisionDateNil() {
...
func (o *SITExtensionV2) SetOfficeRemarksNil() {
...
func (o SITExtensionV2) MarshalJSON() ([]byte, error) {
...
func (o SITExtensionV2) ToMap() (map[string]interface{}, error) {
...
type NullableSITExtensionV2 struct {
	value *SITExtensionV2
	isSet bool
}

func (v NullableSITExtensionV2) Get() *SITExtensionV2 {
	return v.value
}

func (v *NullableSITExtensionV2) Set(val *SITExtensionV2) {
	v.value = val
	v.isSet = true
}

func (v NullableSITExtensionV2) IsSet() bool {
	return v.isSet
}

func (v *NullableSITExtensionV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSITExtensionV2(val *SITExtensionV2) *NullableSITExtensionV2 {
	return &NullableSITExtensionV2{value: val, isSet: true}
}

func (v NullableSITExtensionV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSITExtensionV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
