...
// checks if the MTOServiceItemDomesticCrating type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MTOServiceItemDomesticCrating{}
...
type _MTOServiceItemDomesticCrating MTOServiceItemDomesticCrating
...
func NewMTOServiceItemDomesticCrating(reServiceCode string, item map[string]interface{}, crate map[string]interface{}, description string, moveTaskOrderID string, modelType MTOServiceItemModelType) *MTOServiceItemDomesticCrating {
	this := MTOServiceItemDomesticCrating{}
...
func (o *MTOServiceItemDomesticCrating) SetReasonNil() {
	o.Reason.Set(nil)
}
...
func (o *MTOServiceItemDomesticCrating) SetStandaloneCrateNil() {
...
func (o MTOServiceItemDomesticCrating) MarshalJSON() ([]byte, error) {
...
func (o MTOServiceItemDomesticCrating) ToMap() (map[string]interface{}, error) {
...
func (o *MTOServiceItemDomesticCrating) UnmarshalJSON(data []byte) (err error) {
	...
	varMTOServiceItemDomesticCrating := _MTOServiceItemDomesticCrating{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMTOServiceItemDomesticCrating)

	if err != nil {
		return err
	}

	*o = MTOServiceItemDomesticCrating(varMTOServiceItemDomesticCrating)

	return err
}

type NullableMTOServiceItemDomesticCrating struct {
	value *MTOServiceItemDomesticCrating
	isSet bool
}

func (v NullableMTOServiceItemDomesticCrating) Get() *MTOServiceItemDomesticCrating {
	return v.value
}

func (v *NullableMTOServiceItemDomesticCrating) Set(val *MTOServiceItemDomesticCrating) {
	v.value = val
	v.isSet = true
}

func (v NullableMTOServiceItemDomesticCrating) IsSet() bool {
	return v.isSet
}

func (v *NullableMTOServiceItemDomesticCrating) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMTOServiceItemDomesticCrating(val *MTOServiceItemDomesticCrating) *NullableMTOServiceItemDomesticCrating {
	return &NullableMTOServiceItemDomesticCrating{value: val, isSet: true}
}

func (v NullableMTOServiceItemDomesticCrating) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMTOServiceItemDomesticCrating) UnmarshalJSON(src []byte) error {
	v.isSet = true
