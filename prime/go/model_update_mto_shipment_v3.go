...
// checks if the UpdateMTOShipmentV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateMTOShipmentV3{}

// UpdateMTOShipmentV3 struct for UpdateMTOShipmentV3
type UpdateMTOShipmentV3 struct {
	...
	PpmShipment *UpdatePPMShipmentV3V3 `json:"ppmShipment,omitempty"`
}
...
func (o *UpdateMTOShipmentV3) SetActualProGearWeightNil() {
...
func (o *UpdateMTOShipmentV3) SetActualSpouseProGearWeightNil() {
...
func (o *UpdateMTOShipmentV3) SetScheduledPickupDateNil() {
...
func (o *UpdateMTOShipmentV3) SetActualPickupDateNil() {
...
func (o *UpdateMTOShipmentV3) SetFirstAvailableDeliveryDateNil() {
...
func (o *UpdateMTOShipmentV3) SetScheduledDeliveryDateNil() {
...
func (o *UpdateMTOShipmentV3) SetActualDeliveryDateNil() {
...
func (o *UpdateMTOShipmentV3) SetPrimeEstimatedWeightNil() {
...
func (o *UpdateMTOShipmentV3) SetPrimeActualWeightNil() {
...
func (o *UpdateMTOShipmentV3) SetNtsRecordedWeightNil() {
...
func (o *UpdateMTOShipmentV3) SetDestinationTypeNil() {
...
func (o *UpdateMTOShipmentV3) SetCounselorRemarksNil() {
...
// SetPpmShipment gets a reference to the given UpdatePPMShipmentV3V3 and assigns it to the PpmShipment field.
func (o *UpdateMTOShipmentV3) SetPpmShipment(v UpdatePPMShipmentV3V3) {
	o.PpmShipment = &v
}

func (o UpdateMTOShipmentV3) MarshalJSON() ([]byte, error) {
...
func (o UpdateMTOShipmentV3) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateMTOShipmentV3 struct {
	value *UpdateMTOShipmentV3
	isSet bool
}

func (v NullableUpdateMTOShipmentV3) Get() *UpdateMTOShipmentV3 {
	return v.value
}

func (v *NullableUpdateMTOShipmentV3) Set(val *UpdateMTOShipmentV3) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateMTOShipmentV3) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateMTOShipmentV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateMTOShipmentV3(val *UpdateMTOShipmentV3) *NullableUpdateMTOShipmentV3 {
	return &NullableUpdateMTOShipmentV3{value: val, isSet: true}
}

func (v NullableUpdateMTOShipmentV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateMTOShipmentV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
