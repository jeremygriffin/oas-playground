...
// checks if the CreateMTOShipmentV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateMTOShipmentV3{}

// CreateMTOShipmentV3 struct for CreateMTOShipmentV3
type CreateMTOShipmentV3 struct {
	...
	ShipmentType MTOShipmentTypeV3V3 `json:"shipmentType"`
	...
	PpmShipment *CreatePPMShipmentV3V3 `json:"ppmShipment,omitempty"`
}

type _CreateMTOShipmentV3 CreateMTOShipmentV3
...
func (o *CreateMTOShipmentV3) SetRequestedPickupDateNil() {
...
func (o *CreateMTOShipmentV3) SetPrimeEstimatedWeightNil() {
...
func (o *CreateMTOShipmentV3) SetCustomerRemarksNil() {
...
func (o *CreateMTOShipmentV3) SetCounselorRemarksNil() {
...
// SetPpmShipment gets a reference to the given CreatePPMShipmentV3V3 and assigns it to the PpmShipment field.
func (o *CreateMTOShipmentV3) SetPpmShipment(v CreatePPMShipmentV3V3) {
	o.PpmShipment = &v
}

func (o CreateMTOShipmentV3) MarshalJSON() ([]byte, error) {
...
func (o CreateMTOShipmentV3) ToMap() (map[string]interface{}, error) {
...
func (o *CreateMTOShipmentV3) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateMTOShipmentV3 := _CreateMTOShipmentV3{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateMTOShipmentV3)

	if err != nil {
		return err
	}

	*o = CreateMTOShipmentV3(varCreateMTOShipmentV3)

	return err
}

type NullableCreateMTOShipmentV3 struct {
	value *CreateMTOShipmentV3
	isSet bool
}

func (v NullableCreateMTOShipmentV3) Get() *CreateMTOShipmentV3 {
	return v.value
}

func (v *NullableCreateMTOShipmentV3) Set(val *CreateMTOShipmentV3) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMTOShipmentV3) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMTOShipmentV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMTOShipmentV3(val *CreateMTOShipmentV3) *NullableCreateMTOShipmentV3 {
	return &NullableCreateMTOShipmentV3{value: val, isSet: true}
}

func (v NullableCreateMTOShipmentV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateMTOShipmentV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
