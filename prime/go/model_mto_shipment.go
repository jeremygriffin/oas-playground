...
// checks if the MTOShipment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MTOShipment{}

// MTOShipment struct for MTOShipment
...
func (o *MTOShipment) SetApprovedDateNil() {
...
func (o *MTOShipment) SetRequestedPickupDateNil() {
...
func (o *MTOShipment) SetRequestedDeliveryDateNil() {
...
func (o *MTOShipment) SetScheduledPickupDateNil() {
...
func (o *MTOShipment) SetActualPickupDateNil() {
...
func (o *MTOShipment) SetFirstAvailableDeliveryDateNil() {
...
func (o *MTOShipment) SetRequiredDeliveryDateNil() {
...
func (o *MTOShipment) SetScheduledDeliveryDateNil() {
...
func (o *MTOShipment) SetActualDeliveryDateNil() {
...
func (o *MTOShipment) SetPrimeEstimatedWeightNil() {
...
func (o *MTOShipment) SetPrimeEstimatedWeightRecordedDateNil() {
...
func (o *MTOShipment) SetPrimeActualWeightNil() {
...
func (o *MTOShipment) SetNtsRecordedWeightNil() {
...
func (o *MTOShipment) SetCustomerRemarksNil() {
...
func (o *MTOShipment) SetCounselorRemarksNil() {
...
func (o *MTOShipment) SetActualProGearWeightNil() {
...
func (o *MTOShipment) SetActualSpouseProGearWeightNil() {
...
func (o *MTOShipment) SetDestinationTypeNil() {
...
func (o *MTOShipment) SetDiversionReasonNil() {
...
func (o *MTOShipment) SetPpmShipmentNil() {
...
func (o *MTOShipment) SetOriginSitAuthEndDateNil() {
...
func (o *MTOShipment) SetDestinationSitAuthEndDateNil() {
...
func (o MTOShipment) MarshalJSON() ([]byte, error) {
...
func (o MTOShipment) ToMap() (map[string]interface{}, error) {
...
type NullableMTOShipment struct {
	value *MTOShipment
	isSet bool
}

func (v NullableMTOShipment) Get() *MTOShipment {
	return v.value
}

func (v *NullableMTOShipment) Set(val *MTOShipment) {
	v.value = val
	v.isSet = true
}

func (v NullableMTOShipment) IsSet() bool {
	return v.isSet
}

func (v *NullableMTOShipment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMTOShipment(val *MTOShipment) *NullableMTOShipment {
	return &NullableMTOShipment{value: val, isSet: true}
}

func (v NullableMTOShipment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMTOShipment) UnmarshalJSON(src []byte) error {
	v.isSet = true
