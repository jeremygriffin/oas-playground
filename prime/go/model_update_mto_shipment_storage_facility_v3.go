...
// checks if the UpdateMTOShipmentStorageFacilityV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateMTOShipmentStorageFacilityV3{}

// UpdateMTOShipmentStorageFacilityV3 struct for UpdateMTOShipmentStorageFacilityV3
type UpdateMTOShipmentStorageFacilityV3 struct {
...
func NewUpdateMTOShipmentStorageFacilityV3() *UpdateMTOShipmentStorageFacilityV3 {
	this := UpdateMTOShipmentStorageFacilityV3{}
	return &this
}
...
func (o *UpdateMTOShipmentStorageFacilityV3) SetLotNumberNil() {
	o.LotNumber.Set(nil)
}
...
func (o *UpdateMTOShipmentStorageFacilityV3) SetPhoneNil() {
	o.Phone.Set(nil)
}
...
func (o *UpdateMTOShipmentStorageFacilityV3) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o UpdateMTOShipmentStorageFacilityV3) MarshalJSON() ([]byte, error) {
...
func (o UpdateMTOShipmentStorageFacilityV3) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateMTOShipmentStorageFacilityV3 struct {
	value *UpdateMTOShipmentStorageFacilityV3
	isSet bool
}

func (v NullableUpdateMTOShipmentStorageFacilityV3) Get() *UpdateMTOShipmentStorageFacilityV3 {
	return v.value
}

func (v *NullableUpdateMTOShipmentStorageFacilityV3) Set(val *UpdateMTOShipmentStorageFacilityV3) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateMTOShipmentStorageFacilityV3) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateMTOShipmentStorageFacilityV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateMTOShipmentStorageFacilityV3(val *UpdateMTOShipmentStorageFacilityV3) *NullableUpdateMTOShipmentStorageFacilityV3 {
	return &NullableUpdateMTOShipmentStorageFacilityV3{value: val, isSet: true}
}

func (v NullableUpdateMTOShipmentStorageFacilityV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateMTOShipmentStorageFacilityV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
