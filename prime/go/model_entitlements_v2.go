...
// checks if the EntitlementsV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitlementsV2{}

// EntitlementsV2 struct for EntitlementsV2
type EntitlementsV2 struct {
...
func (o *EntitlementsV2) SetAuthorizedWeightNil() {
...
func (o *EntitlementsV2) SetDependentsAuthorizedNil() {
...
func (o *EntitlementsV2) SetNonTemporaryStorageNil() {
...
func (o *EntitlementsV2) SetPrivatelyOwnedVehicleNil() {
...
func (o EntitlementsV2) MarshalJSON() ([]byte, error) {
...
func (o EntitlementsV2) ToMap() (map[string]interface{}, error) {
...
type NullableEntitlementsV2 struct {
	value *EntitlementsV2
	isSet bool
}

func (v NullableEntitlementsV2) Get() *EntitlementsV2 {
	return v.value
}

func (v *NullableEntitlementsV2) Set(val *EntitlementsV2) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitlementsV2) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitlementsV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitlementsV2(val *EntitlementsV2) *NullableEntitlementsV2 {
	return &NullableEntitlementsV2{value: val, isSet: true}
}

func (v NullableEntitlementsV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitlementsV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
