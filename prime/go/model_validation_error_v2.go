...
// checks if the ValidationErrorV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidationErrorV2{}

// ValidationErrorV2 struct for ValidationErrorV2
...
type _ValidationErrorV2 ValidationErrorV2
...
func (o ValidationErrorV2) MarshalJSON() ([]byte, error) {
...
func (o ValidationErrorV2) ToMap() (map[string]interface{}, error) {
...
func (o *ValidationErrorV2) UnmarshalJSON(data []byte) (err error) {
	...
	varValidationErrorV2 := _ValidationErrorV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varValidationErrorV2)

	if err != nil {
		return err
	}

	*o = ValidationErrorV2(varValidationErrorV2)

	return err
}

type NullableValidationErrorV2 struct {
	value *ValidationErrorV2
	isSet bool
}

func (v NullableValidationErrorV2) Get() *ValidationErrorV2 {
	return v.value
}

func (v *NullableValidationErrorV2) Set(val *ValidationErrorV2) {
	v.value = val
	v.isSet = true
}

func (v NullableValidationErrorV2) IsSet() bool {
	return v.isSet
}

func (v *NullableValidationErrorV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidationErrorV2(val *ValidationErrorV2) *NullableValidationErrorV2 {
	return &NullableValidationErrorV2{value: val, isSet: true}
}

func (v NullableValidationErrorV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidationErrorV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
