...
// checks if the MoveTaskOrderV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MoveTaskOrderV2{}

// MoveTaskOrderV2 struct for MoveTaskOrderV2
type MoveTaskOrderV2 struct {
	Id *string `json:"id,omitempty"`
	MoveCode *string `json:"moveCode,omitempty"`
	CreatedAt *time.Time `json:"createdAt,omitempty"`
	OrderID *string `json:"orderID,omitempty"`
	Order *OrderV2V2 `json:"order,omitempty"`
	...
	PaymentRequests []PaymentRequestV2V2 `json:"paymentRequests"`
	MtoServiceItems []MTOServiceItemV2V2 `json:"mtoServiceItems"`
	// A list of shipments without their associated service items.
	MtoShipments []MTOShipmentWithoutServiceItemsV2V2 `json:"mtoShipments"`
...
type _MoveTaskOrderV2 MoveTaskOrderV2
...
// SetOrder gets a reference to the given OrderV2V2 and assigns it to the Order field.
...
func (o *MoveTaskOrderV2) SetAvailableToPrimeAtNil() {
...
func (o *MoveTaskOrderV2) SetPrimeCounselingCompletedAtNil() {
...
func (o *MoveTaskOrderV2) GetMtoShipments() []MTOShipmentWithoutServiceItemsV2V2 {
	if o == nil {
		var ret []MTOShipmentWithoutServiceItemsV2V2
		return ret
	}
...
func (o *MoveTaskOrderV2) SetExcessWeightQualifiedAtNil() {
...
func (o *MoveTaskOrderV2) SetExcessWeightAcknowledgedAtNil() {
...
func (o *MoveTaskOrderV2) SetExcessWeightUploadIdNil() {
...
func (o MoveTaskOrderV2) MarshalJSON() ([]byte, error) {
...
func (o MoveTaskOrderV2) ToMap() (map[string]interface{}, error) {
...
func (o *MoveTaskOrderV2) UnmarshalJSON(data []byte) (err error) {
	...
	varMoveTaskOrderV2 := _MoveTaskOrderV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMoveTaskOrderV2)

	if err != nil {
		return err
	}

	*o = MoveTaskOrderV2(varMoveTaskOrderV2)

	return err
}

type NullableMoveTaskOrderV2 struct {
	value *MoveTaskOrderV2
	isSet bool
}

func (v NullableMoveTaskOrderV2) Get() *MoveTaskOrderV2 {
	return v.value
}

func (v *NullableMoveTaskOrderV2) Set(val *MoveTaskOrderV2) {
	v.value = val
	v.isSet = true
}

func (v NullableMoveTaskOrderV2) IsSet() bool {
	return v.isSet
}

func (v *NullableMoveTaskOrderV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMoveTaskOrderV2(val *MoveTaskOrderV2) *NullableMoveTaskOrderV2 {
	return &NullableMoveTaskOrderV2{value: val, isSet: true}
}

func (v NullableMoveTaskOrderV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMoveTaskOrderV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
