...
// checks if the UpdateMTOShipmentStorageFacilityV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateMTOShipmentStorageFacilityV2{}

// UpdateMTOShipmentStorageFacilityV2 struct for UpdateMTOShipmentStorageFacilityV2
type UpdateMTOShipmentStorageFacilityV2 struct {
...
func NewUpdateMTOShipmentStorageFacilityV2() *UpdateMTOShipmentStorageFacilityV2 {
	this := UpdateMTOShipmentStorageFacilityV2{}
	return &this
}
...
func (o *UpdateMTOShipmentStorageFacilityV2) SetLotNumberNil() {
	o.LotNumber.Set(nil)
}
...
func (o *UpdateMTOShipmentStorageFacilityV2) SetPhoneNil() {
	o.Phone.Set(nil)
}
...
func (o *UpdateMTOShipmentStorageFacilityV2) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o UpdateMTOShipmentStorageFacilityV2) MarshalJSON() ([]byte, error) {
...
func (o UpdateMTOShipmentStorageFacilityV2) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateMTOShipmentStorageFacilityV2 struct {
	value *UpdateMTOShipmentStorageFacilityV2
	isSet bool
}

func (v NullableUpdateMTOShipmentStorageFacilityV2) Get() *UpdateMTOShipmentStorageFacilityV2 {
	return v.value
}

func (v *NullableUpdateMTOShipmentStorageFacilityV2) Set(val *UpdateMTOShipmentStorageFacilityV2) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateMTOShipmentStorageFacilityV2) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateMTOShipmentStorageFacilityV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateMTOShipmentStorageFacilityV2(val *UpdateMTOShipmentStorageFacilityV2) *NullableUpdateMTOShipmentStorageFacilityV2 {
	return &NullableUpdateMTOShipmentStorageFacilityV2{value: val, isSet: true}
}

func (v NullableUpdateMTOShipmentStorageFacilityV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateMTOShipmentStorageFacilityV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
