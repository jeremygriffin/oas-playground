...
class ShipmentAddressUpdate < ApplicationRecord
  validates_presence_of :id
  validates_presence_of :contractor_remarks
  validates_presence_of :status
  validates_presence_of :shipment_id
  validates_presence_of :original_address
  validates_presence_of :new_address
