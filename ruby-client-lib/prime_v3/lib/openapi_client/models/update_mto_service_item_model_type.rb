...
module OpenapiClient
  class UpdateMTOServiceItemModelType
    ...
    def build_from_hash(value)
      return value if UpdateMTOServiceItemModelType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #UpdateMTOServiceItemModelType"
    end
  end
end
