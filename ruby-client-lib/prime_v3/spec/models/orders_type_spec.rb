...
# Unit tests for OpenapiClient::OrdersType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrdersType do
  let(:instance) { OpenapiClient::OrdersType.new }

  describe 'test an instance of OrdersType' do
    it 'should create an instance of OrdersType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrdersType)
    end
  end
